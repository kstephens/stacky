...
#include "types.h"
  ...
  s_call(s_symbol_new("["),  v_mark, core_dict, s_f(dict_set));
  s_call(s_symbol_new("]"), s_f(array_end), core_dict, s_f(dict_set));
  s_call(s_symbol_new("{{"), v_mark, core_dict, s_f(dict_set));
  s_call(array_exec_begin = s_symbol_new("{"), v_mark, core_dict, s_f(dict_set));
  s_call(array_exec_end = s_symbol_new("}"), s_f(array_end_exec), core_dict, s_f(dict_set));
#ifndef TYPE
